...
class FlowEditGuider(CFGGuider):
    ...
    def predict_noise(self, x, timestep, model_options={}, seed=None):
        ...
        # Multiple samples case for more stable sampling
        predictions = None
...
class WanFlowEditGuiderAdvNode:
    @classmethod
    def INPUT_TYPES(s):
        return {"required":
                    {
...
class WanFlowEditGuiderCFGNode:
    @classmethod
    def INPUT_TYPES(s):
        return {"required":
                    {
...
class WanFlowEditGuiderCFGAdvNode:
    @classmethod
    def INPUT_TYPES(s):
        return {"required":
                    {
